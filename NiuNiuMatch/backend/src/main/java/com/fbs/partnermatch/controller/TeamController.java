...
import com.fbs.partnermatch.common.DeleteRequest;
...
import com.fbs.partnermatch.model.request.TeamAddRequest;
...
public class TeamController {
    ...
    public BaseResponse<List<TeamUserVO>> listMyJoinTeams(TeamQuery teamQuery,HttpServletRequest request){
        ...
        listMap = userTeamList.stream().collect(Collectors.groupingBy(UserTeam::getTeamId));//按照teamId分组
